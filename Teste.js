...
// if(resposta == 1){
//     const resp = 'Muito bom! Continue estudando e você terá muito sucesso.'
//     alert(resp)
// }else if(resposta == 2){
//     const pesr = 'Ahh que pena... Já tentou aprender outras linguagens?'
//     alert(pesr)
// }
for(i=0; i < 2; i++){
    let areas = prompt("Tem alguma tecnologia que vc deseja seguir?")
    let saera = areas.split(" ")
    let count = 0;
    console.log(saera[i])
}